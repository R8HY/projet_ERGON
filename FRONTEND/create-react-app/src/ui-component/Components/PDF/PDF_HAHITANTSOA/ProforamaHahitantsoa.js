...
const styles = StyleSheet.create({
    backgroundImage: {
      ...
      opacity: 0.2, // Ajuster l'opacité si nécessaire
      width: '120%', // Pour étendre sur toute la largeur
      height: '55%', // Pour occuper 80% de la hauteur de la page
  ...
  <View style={{display:'flex', flexDirection:'row'}}>
    ...
    {/*tableau 2 */}
      <View style={{border:'1px', marginTop:'50px', width:'90%', marginLeft:'10px'}}>
        <View>
            <View style={{display:'flex', flexDirection:'row', justifyContent:'flex-end',paddingLeft:'10px', paddingTop:'1px', backgroundColor:'#c3c3c3', fontSize:'10px', height:'20px'}}>
                <View>
...
export default ProforamaHahitantsoa;
