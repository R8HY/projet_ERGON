...
function ProfilePage() {
  ...
  useEffect(() => {
    ...
    var apiUrl =`http://127.0.0.1:8000/store/Location/Decoration/${params.id}`;
    ...
    fetch(apiUrl)
      ...
      .then((produit) => {
        ...
        setTypeProduit(produit.categorie);
        apiUrl =`http://127.0.0.1:8000/store/Location/TypeDeco/${produit.categorie}`;
          ...
          <Grid container xs={12} sm={12} md={12} lg={4}>
            ...
            <MDBCard data-aos="zoom-in" className="mb-4 h-100">
                <MDBCardBody>
                  <MDBRow>
                    <MDBCol sm="3">
                      <MDBCardText>Decoration</MDBCardText>
                    </MDBCol>
                    <MDBCol sm="9">
                      <input
                  ...
                  <MDBRow>
                    ...
                    <MDBCol sm="9">
                        <MDBCardText className="text-muted">{categorie.titre} <span style={{color:'black', marginLeft:"30%"}}>id:</span><input
                        className="text-muted noBorder-input"
                        value={typeProduit}
            ...
            <Grid style={{marginLeft:"10px", marginRight:"10px"}} lg={12}>
              <MDBCard data-aos="zoom-in" className="mb-4 mt-3" style={{height:"670px"}}>
                <MDBCardBody>
                  ...
                  <ListeSortie type="DecorationPanier" id={produit.id}/>
                </MDBCardBody>
              </MDBCard>
            </Grid>
          </Grid>
