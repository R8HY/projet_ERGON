...
export default function SettingsCard({donnees, setModification}) {
  ...
  const [showMessageUpdated, setShowMessageUpdated] = React.useState(false);
  ...
  return (
    <Card variant="outlined" sx={{ height: "95%", width: "98%" }} style={{ borderRadius:'20px'}} className="mb-4">
      ...
      >
        ...
        <Tab value="two" label="Activités" />
      </Tabs>
      <Divider></Divider>
      <MessageModal showForm={showMessageUpdated} setShowForm={setShowMessageUpdated} message="Les informations ont bien été modifiées"/>
