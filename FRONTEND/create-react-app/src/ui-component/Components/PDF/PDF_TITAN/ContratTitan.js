...
const ContratTitan = ({idClient, id_panier}) => {
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        const apiUrl = `http://127.0.0.1:8000/store/Societe/${idClient}`;
        ...
        fetch(apiUrl)
          ...
          .then((data) => {
            setSocieteData(data);
            console.log('Les donnees des societe sont bien récupérer');
          })
          .catch((error) => {
            console.error('Error fetching data:', error, 'noob');
          });
  ...
  <Image src={logo} style={styles.backgroundImage} />
        <View>
            ...
            <View style={{display:'flex', flexDirection:'row', justifyContent:'space-between', marginBottom:'25px'}}>
                <View>
                    <View>
                        <Image src={logo} alt="logo" style={{width:'110px', height:'100px'}}/> 
                    </View>
            ...
            <View style={{marginTop:'20px', width:'100%'}}>
                ...
                <View style={{fontSize:'9px', lineHeight: 1.5}}>
                    <Text>
                        ...
                        délègue à {client.nom} le présent contrat
                    </Text>
                </View>
            </View>
            ...
            <View style={{marginTop:'10px', width:'100%'}}>
                <View style={{fontSize:'9px', lineHeight: 1.5}}>
                    <Text>
                        La société ’’{societeData.nomSociete}’’ domiciliée {societeData.domiciliation}
                    </Text>
                </View>
  ...
  <Image src={logo} style={styles.backgroundImage} />
    ...
    <View style={{display:'flex', alignItems:'center'}}>
        <View>
            <Image src={logo} alt="logo" style={{width:'85px', height:'75px'}}/> 
        </View>
    </View>
    ...
    <View>
        ...
        <View style={{fontSize:'9px',  marginBottom:'8px', lineHeight:1.4}}>
            <Text>
            Dans le cas où le client n’aurait pas rendu les Matériels loués aux date et heure indiquées à l’article 8, le Client devra payer la somme supplémentaire de 80% du montant 
            total de la facture par jour de non remise des Matériels Loués. 
            </Text>
        </View>
        <View style={{fontSize:'9px',  marginBottom:'8px', lineHeight:1.4}}>
            <Text>
