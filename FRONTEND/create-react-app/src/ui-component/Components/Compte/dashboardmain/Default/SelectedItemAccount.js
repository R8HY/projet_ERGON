...
// assets
import StorefrontTwoToneIcon from '@mui/icons-material/AttachMoney';
...
const TotalIncomeLightCard = ({ isLoading, account }) => {
  ...
  return (
    <>
      {isLoading ? (
        ...
        <CardWrapper className="mb-4-none" border={false} content={false}>
          <Box sx={{ p: 2 }}>
            <List sx={{ py: 0 }}>
              <ListItem alignItems="center" disableGutters sx={{ py: 0 }}>
                ...
                <ListItemText
                  ...
                  primary={<Typography variant="h4">{account.solde?formatSolde(account):account.solde} Ar</Typography>}
                  secondary={
                    <Typography
                      variant="subtitle2"
                      sx={{
