...
import FormPanier from 'ui-component/Components/Panier/FormPanier';
                ...
                <div key={type.id}>
                  ...
                  <Modal show={showFormPanier} onHide={() => setShowFormPanier(false)} centered>
                    <Modal.Header closeButton className="custom-modal-header" style={{ backgroundColor: '#3399FF', color: 'white' }}>
                      <Modal.Title>Entrer la societe</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                      <FormPanier onSubmit={handleFormSubmit} idProduit={idProduit} id_panier={params.idPanier} nomProduit={nomProduit} prix_unitaire={prixUnitaire} setShowFormPanier={setShowFormPanier}/>
                    </Modal.Body>
                    <Modal.Footer>
